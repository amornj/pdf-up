...
### Zotero
Zotero integration uses the [Zotero Web API v3](https://www.zotero.org/support/dev/web_api/v3/start). You need a Zotero API key (generate at https://www.zotero.org/settings/keys) and your user ID.

The integration:
- Looks up or creates a target collection (if `zotero_collection` is set)
